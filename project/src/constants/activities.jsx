...
export const ACTIVITIES = [
  { id: "001", exerciseId: 'squat', name: 'Przysiad Klasyczny', category: 'Nogi',modelPath: '/models/Air Squat.fbx', time: '15m', icon: <Zap size={16} className="text-amber-400"/>, achievement: "Król Przysiadów" },
  { id: "002", exerciseId: 'pushup', name: 'Pompki', category: 'Klatka',modelPath: '/models/Push Up.fbx', time: '10m', icon: <Dumbbell size={16} className="text-sky-400"/>, achievement: "Twardy jak Diament" },
  { id: "003", name: 'Plank (Deska)', category: 'Core', time: '5m', icon: <Timer size={16} className="text-emerald-400"/>, achievement: "Łamacz Desek" },
  { id: "004", exerciseId: 'lunge', name: 'Wykroki AI', category: 'Nogi', time: '20m', icon: <Zap size={16} className="text-amber-400"/>, achievement: "Cyber-Wykrok" },
  ...
  { id: "009", exerciseId: 'jumping_jacks', name: 'Pajacyki AI', category: 'Kardio', time: '10m', icon: <Flame size={16} className="text-red-500"/>, achievement: "Piekielna Kondycja" },
